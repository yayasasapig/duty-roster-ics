lucide.createIcons();
    ...
    function makeVEVENT(dtstart,dtend,summary,uid){return['BEGIN:VEVENT','DTSTART;TZID=Asia/Hong_Kong:'+dtstart,'DTEND;TZID=Asia/Hong_Kong:'+dtend,'SUMMARY:'+summary,'UID:'+uid,'END:VEVENT'].join('\r\n');}
